...
public class allergyanaphylaxisresult extends AppCompatActivity {
    HistoryHelper helper = new HistoryHelper(this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_allergyanaphylaxisresult);
        ...
        ht.setHuname(data);
        ht.setDname("Allergy Anaphylaxis");
