...
public class DatabaseHelper1 extends SQLiteOpenHelper {
    ...
    private static final String TABLE_CREATE=
            "create table doctor(id integer primary key not null , name text not null , email text not null , username text not null , password text not null)";
    ...
    public String searchPass(String username)
    {
        ...
        String searchQuery ="Select username,password from doctor";
    ...
    {
        db= this.getReadableDatabase();
        String Equery = "Select username,password from doctor";
    ...
    {
        db= this.getReadableDatabase();
        String Equery = "Select username from doctor";
        Cursor c = db.rawQuery(Equery,null);
        boolean valid =true;
        String a;
        if(c.moveToFirst())
