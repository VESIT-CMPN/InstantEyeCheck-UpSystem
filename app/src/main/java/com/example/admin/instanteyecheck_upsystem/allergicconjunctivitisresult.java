...
public class allergicconjunctivitisresult extends AppCompatActivity {
    HistoryHelper helper = new HistoryHelper(this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_allergicconjunctivitisresult);
        ...
        ht.setHuname(data);
        ht.setDname("Allergic Conjunctivitis");
